        ...
        <div className=' bg-gray-100 py-14'>
            <div className='lg:max-w-[1440px]  mx-auto '>
                <div className='text-center px-2'>
                    ...
                    <p className='text-gray-400 md:font-md my-5'>At HERO.IO, we craft innovative apps designed to make everyday life simpler, smarter,  and <br />more  exciting.Our goal is to turn your ideas into <br /> digital experiences that truly make an impact.</p>
                </div>
            ...
            <div className="bg-linear-to-r from-[#632EE3] to-[#9F62F2]">    
                ...
                <div className="lg:max-w-[1440px]  mx-auto py-15 text-center">
                    <h1 className="lg:text-6xl text-3xl font-bold text-white mb-15">Trusted by Millions, Built for You</h1>
                    <div className="lg:flex justify-center gap-16">
                        <div>
                            <small className="text-lg font-light text-white">Total Download</small>
                            <h2 className=" text-3xl md:text-5xl lg:text-7xl font-bold text-white">29.6M</h2>
